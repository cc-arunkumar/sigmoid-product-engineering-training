...
router.post("/api/products",protect,validator,productController.createProduct)
router.put("/api/product/:id",protect,validator,productController.updateProduct);
router.patch("/api/product/:id",protect,patchvalidator,productController.updatePartialProduct);
