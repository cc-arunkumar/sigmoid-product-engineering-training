...
@router.post("/")
def add_product(product:Product_Put_Post):
...
def update_product(product_data:Product_Put_Post,product_id:int):
...
def update_product_partial(product_data: Product_Patch,product_id:int):
