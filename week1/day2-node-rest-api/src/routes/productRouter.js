...
router.get("/api/products", protect, authorize("user", "admin"), productController.getAllProducts);
router.get("/api/products/:id", protect, authorize("user", "admin"), productController.getProductById);
